...
export function ExperienceSection() {
  const experiences: ExperienceItemProps[] = [
    ...
    },
    {
      ...
      company: "Rastar Games",
      description:
        "Benchmarked 10+ top-performing mobile and PC games using retention and monetization metrics, then synthesized findings into weekly reports. Built a three-tier RFM-style user segmentation model from global spending and engagement data, and used SQL/Python to turn raw data into acquisition, retention, engagement, and monetization KPIs tracked through Excel dashboards.",
      skills: [
        "SQL",
        "Python",
        "Excel",
